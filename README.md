...
582-31F-VA (Fall 2024) \
Section number 93103 \
60 hours (2-2-2)

Absolute prerequisite:  Web Interface Programming 1 (582-21F-VA)
...
In this course, students are introduced to object-oriented programming.
They learn its main concepts as well as the syntax needed to put these
concepts into practice using JavaScript. Special attention is given to
organizing source code using modules and classes. Student are also
introduced to asynchronous programming. They learn to make requests
using JavaScript's native programming interfaces, and to insert the
received data into HTML documents.
...
| -: | ----- | ------------------------- | ---------- | --------------- |
|  1 | 08/06 | Introduction              | Online     |                 |
|  2 | 08/08 | Abstract data types       | Online     |                 |
|  3 | 08/13 | Encapsulation             | In-person* |                 |
...
LIA for this course involves developing a small single-page application.
...
#### EHP1: Program animated and interactive web interfaces

1.  Program the interactivity and animation of web interfaces.	

    1.  Proper use of an event-driven programming language
    2.  Accurate control of DOM elements
    3.  Accurate control of the interface animation
    4.  Accurate management of the interface interactivity
    5.  Accurate management of the interface states
    6.  Proper adaptation of the programming to the various display
        devices
    7.  Sound use of current libraries

2.  Process data related to animated and interactive web interfaces.

    1.  Proper processing of data to be sent to a server
    2.  Methodical management of requests with a server
    3.  Proper processing of the response to a request on a server
    4.  Proper processing of the data to be displayed
